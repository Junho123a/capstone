...
class DLinearTrainingSystem:
    ...
    def build_dlinear_model(self):
        ...
        # Seasonal component processing (LSTM 제거)
    ...
    def train_and_save(self, csv_path, save_dir='saved_models'):
        ...
        save_model(self.model, os.path.join(save_dir, 'dlinear_model.h5'))
